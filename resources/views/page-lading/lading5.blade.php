...
<section>
        <div class="card-structure">
            <div class="principal-title">
                ...
                <h3>¿Te gustaría que el slider de la landing page sea administrable?</h3>
                <p>El slider es un carrusel de imágenes con enlaces que se encuentra al inicio de la landing page</p>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="btn-space">
            <button type="button" class="back-btn" onclick="window.location.href = '/page-lading/lading4';">&#129044; ANTERIOR</button>
            ...
            <button type="submit" class="next-btn" onclick="window.location.href = '/page-lading/lading6';">SIGUIENTE &#10142;</button>
        </div>
    </section>
</body>
