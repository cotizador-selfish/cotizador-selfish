...
<body>
        ...
        <div class="option-container">
            ...
            <div class="option-row option-hscard" id="myButton{{ $key }}" onclick="toggleSelected('{{ $key }}', '{{ $dato->price }}')">
                ...
                <div class="option-text">
                    <h6 style="margin-top:0px; margin-bottom: 10px; color:#999999; text-transform: uppercase;">{{ htmlspecialchars($dato->title) }}</h6>
    ...
    <section>
        <div class="btn-space">
            <button type="button" class="back-btn" onclick="window.location.href = '/page-lading/lading6';">&#129044; ANTERIOR</button>
