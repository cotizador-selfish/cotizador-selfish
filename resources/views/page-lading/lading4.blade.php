...
<section>
    ...
    <section>
        <div class="btn-space">
            <button type="button" class="back-btn" onclick="window.location.href = '/page-lading/lading3';">&#129044; ANTERIOR</button>
            ...
            <button type="submit" class="next-btn" onclick="window.location.href = '/page-lading/lading5';">SIGUIENTE &#10142;</button>
        </div>
    </section>
</body>
