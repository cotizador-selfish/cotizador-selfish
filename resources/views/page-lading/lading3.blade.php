...
<section>
        <div class="card-structure">
            <div class="principal-title">
                ...
                <h3>¿La landing page requiere vender un producto o servicio?</h3>
                <p>La venta se puede realizar a través de PayPal o Stripe (con cargo directo a tarjetas de crédito/débito).</p>
            </div>
        </div>
    </section>
