...
<section>
    ...
    <section>
        <div class="btn-space">
            <button type="button" class="back-btn" onclick="window.location.href = '/product-catalog/product4';">&#129044; ANTERIOR</button>
            ...
            <button type="submit" class="next-btn" onclick="window.location.href = '/product-catalog/product6';">SIGUIENTE &#10142;</button>
        </div>
    </section>
</body>
