...
<section>
        <div class="card-structure">
            <div class="principal-title">
                ...
                <h3>¿Te gustaría incluir un blog en el catálogo en línea?</h3>
                <p>El blog permite publicar artículos de interés, noticias, eventos y promociones. Además ayuda a mejorar el posicionamiento orgánico.</p>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="btn-space">
            <button type="button" class="back-btn" onclick="window.location.href = '/product-catalog/product3';">&#129044; ANTERIOR</button>
            ...
            <button type="submit" class="next-btn" onclick="window.location.href = '/product-catalog/product5';">SIGUIENTE &#10142;</button>
        </div>
    </section>
</body>
