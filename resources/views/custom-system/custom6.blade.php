...
<body>
    <section>
        <div class="card-structure">
            <div class="principal-title">
                ...
                <h3>¿El proyecto requiere generar facturas?</h3>
                <p>Documentos fiscales con validez ante SAT.</p>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="btn-space">
            <button type="button" class="back-btn" onclick="window.location.href = '/custom-system/custom5';">&#129044; ANTERIOR</button>
            ...
            <button type="submit" class="next-btn" onclick="window.location.href = '/custom-system/custom7';">SIGUIENTE &#10142;</button>
        </div>
    </section>
</body>
