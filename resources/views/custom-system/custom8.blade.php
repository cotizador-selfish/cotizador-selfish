...
<body>
    <section>
        <div class="card-structure">
            <div class="principal-title">
                ...
                <h3>¿El proyecto requiere un control de procesos?</h3>
                <p>En dónde existirán roles diferentes (tipos de usuario) para validar los procesos.</p>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="btn-space">
            <button type="button" class="back-btn" onclick="window.location.href = '/custom-system/custom7';">&#129044; ANTERIOR</button>
            ...
            <button type="submit" class="next-btn" onclick="window.location.href = '/custom-system/custom9';">SIGUIENTE &#10142;</button>
        </div>
    </section>
</body>
