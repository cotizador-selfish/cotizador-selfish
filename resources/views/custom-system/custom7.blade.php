...
<body>
    <section>
        <div class="card-structure">
            <div class="principal-title">
                ...
                <h3>¿El proyecto requiere generar códigos QR?</h3>
                <p>Pueden contener URLs o información de productos.</p>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="btn-space">
            <button type="button" class="back-btn" onclick="window.location.href = '/custom-system/custom6';">&#129044; ANTERIOR</button>
            ...
            <button type="submit" class="next-btn" onclick="window.location.href = '/custom-system/custom8';">SIGUIENTE &#10142;</button>
        </div>
    </section>
</body>
