...
<body>
    <section>
        <div class="card-structure">
            <div class="principal-title">
                ...
                <h3>¿El proyecto requiere conectarse a un sistema externo?</h3>
                <p>Es importante considerar que dicho sistema debe contar con un API y su respectiva documentación.</p>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="btn-space">
            <button type="button" class="back-btn" onclick="window.location.href = '/custom-system/custom8';">&#129044; ANTERIOR</button>
            ...
            <button type="submit" class="next-btn" onclick="window.location.href = '/custom-system/custom10';">SIGUIENTE &#10142;</button>
        </div>
    </section>
</body>
