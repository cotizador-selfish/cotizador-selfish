...
<body>
    <section>
        <div class="card-structure">
            <div class="principal-title">
                ...
                <h3>¿El proyecto requiere registrar ventas manuales?</h3>
                <p>Generalmente conocidas como ventas en mostrador. Tomando en cuenta un inventario previo.</p>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="btn-space">
            <button type="button" class="back-btn" onclick="window.location.href = '/custom-system/custom2';">&#129044; ANTERIOR</button>
            ...
            <button type="submit" class="next-btn" onclick="window.location.href = '/custom-system/custom4';">SIGUIENTE &#10142;</button>
        </div>
    </section>
</body>
