...
<body>
    <section>
        <div class="card-structure">
            <div class="principal-title">
                ...
                <h3>¿Actualmente tienes contratado un dominio?</h3>
                <p>Es importante considerar que dicho sistema cuente actualmente con algun servicio</p>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="btn-space">
            <button type="button" class="back-btn" onclick="window.location.href = '/custom-system/custom9';">&#129044; ANTERIOR</button>
